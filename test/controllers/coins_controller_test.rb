...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { acro: @coin.acro, desc: @coin.desc, img_ulr: @coin.img_ulr } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { acro: @coin.acro, desc: @coin.desc, img_ulr: @coin.img_ulr } }
