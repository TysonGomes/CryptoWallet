class CoinsController < ApplicationController
  ...
  before_action :set_mining_type_opt, only: [:show, :edit, :update, :destroy]
  #layout "adm"
  # GET /coins
  # GET /coins.json
  def index
  ...
  private
     def set_mining_type_opt
      @mining_type_opt = MiningType.all.pluck(:nome ,:id)
     end
    ...
    def coin_params
      params.require(:coin).permit(:desc, :acro, :img_ulr, :mining_type_id)
    end
end
